...
public class MailBodies {
  ...
  public static String getSignUpBody(String userName) {
    ...
    html += "<p style=\"font-size: 17px; text-align: justify; color: #00008c;\">";
    html +=
        "2025 CAMBYZE<a style=\"text-decoration: none; margin-left: 10px; margin-right: 10px\" ";
  ...
  public static String getAccountRequest(String userName, String email, String password) {
    ...
    html += "<div style=\"display: flex; flex-direction: row;\"><a  href=\"https://cambyze.com/\">"
        + '\n';
    html += "<img style=\"width: 400px; height: 80px;\" title=\"Cambyze\" alt=\"Cambyze\"" + '\n';
    html += "src=\"https://cambyze.com/resources/images/cambyze_icon.png\" /></a></div></section>"
        + '\n';
    html +=
    ...
    html += "<p>=> Password: " + password + "</p><p>=> Email: <b>" + email
        + "</p></div></div></div>" + '\n';
    html +=
    ...
    html +=
        "<div style=\"font-size: 18px; color: #fff; margin-left: 55px; margin-right: 10px;\">\u00A9 2020 CAMBYZE</div>"
            + '\n';
    html += "<div style=\"font-size: 18px; color: #fff; margin-left: 10px; margin-right: 10px;\">"
        + '\n';
    html +=
